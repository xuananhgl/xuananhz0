...
<div class="users view large-8 medium-8 columns content" style="background:#efecf3;">
<div class="container">

  <div class="list">
    <span class="material-symbols-outlined my_style">settings</span>
    <?= $this->Html->link(__('customize'), ['controller' => 'Interfaces', 'action' => 'index']) ?>
  </div>
</div>
</div>
