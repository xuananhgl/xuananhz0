...
<body>
            ...
            <div class="a js-app">
              ...
              <div class ="gmail" style="background-color:<?= $display['backgroun_header'] ?>"><h6><i class="fa-solid fa-user-tie"></i>-<?=$user->role?>: <?= $this->Html->link(__(($user->email)), ['controller' => 'Users', 'action' => 'view', $user->id])?></h6></div>
                ...
                <input type="color" id="head" name="color_header" value="<?= $display['color_header'] ?>">
                  ...
                  <h6>image-headers</h6>
                      <input type="text" value="<?= $display['image_header'] ?>" name="image_header"></input>
                  <h6>image pour</h6>
                      <input type="text" value="<?= $display['image_pour'] ?>" name="image_pour"></input>
                    <p>color prou</p>
                      <input type="text" value="<?= $display['color_pour'] ?>" name="color_pour"></input>
                  ...
                  <ul>
                      <i class="fa-solid fa-images" id="image3"></i>
                          <li><div class="image1"><input value="<?=$display->image_header?>"><?= $this->Html->image($display->image_header) ?></input></div></li>
                          <li><div class="image1"><input><?= $this->Html->image($display->image_header) ?></input></div></li>
                          <li><div class="image1"><input><?= $this->Html->image($display->image_header) ?></input></div></li>
                    </ul>
                   </div>
                  <div class="">
